<?php
    ...
    /**
     * @todo:
     * необходимо доработать верстку согласно макетам
     * 1.логотип кликабельный, с переходом на главную+ лого сейчас мутные, потому что увеличенный, исправить; раздел меню-не соот макету, не по центру   (:check:)
     * 2.https://yadi.sk/i/O1Vp188Ps77Ta расписала на макете не соответствия и небольшие правки (:check:)
     * 3.шрифты во всех блоках и всех страницах, строго по макету. Вообщем должна быть точная копия макетов
     * 5.http://frontsite.ru/pt/2016/kmn/stanki/item.php фото в слайде в полном размере должны быть и при перелистывании с маленького фото на большое и наоборот слайд должен подстраеваться, чтобы не было пустых, белых мест (:????:)
     * 6.http://www.stanki-zavod.ru/produktsiya каталог тупо скопировать отсюда, внешний вид,только шрифт сделать тот что используется сейчас на сайте     (:??????:)
     * 7. рефакторинг кода (:check:)
     */
        ...
        <div>
            ...
            <div class="row about">
                ...
                <div class="about_text">
                    <p>
                        ООО Машиностроительное Предприятие «ПромСтройМаш» - завод в структуру которого входят
                        механические,
                        механосборочные цеха. Заготовительное отделение, сварочное, инструментальное,
                        электромонтажное,
                        малярное
                        и отделение термообработки. Предприятием освоено производство более 50 различных моделей
                        оборудования.
                        Продукция завода поставляется в регионы России, республику Беларусь, Казахстан. Особым
                        спросом
                        пользуются ножницы кривошипные электромеханические модели МНГ13, МНГ16,электромеханические
                        трубогибочные
                        станки моделей ИВ3428, ИВ3429, настольно-сверлильные станки моделей 2М112, 2М118, точильно
                        шлифовальные
